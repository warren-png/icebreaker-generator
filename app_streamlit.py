...
# Onglets
tab1, tab2, tab3, tab4 = st.tabs(["🚀 Génération Leonar", "🧪 Test Manuel", "🎯 Génération avec CV", "⭐ Témoignages Clients"])
...
with tab4:
    ...
    if st.button("✨ GÉNÉRER LE PDF TÉMOIGNAGE", type="primary", use_container_width=True):
        ...
        # Sanitisation
        q1_clean = sanitize_text(t_q1, max_length=2000)
        q2_clean = sanitize_text(t_q2, max_length=2000)
        q3_clean = sanitize_text(t_q3, max_length=2000)
        ...
        # Prévisualisation des éléments extraits
